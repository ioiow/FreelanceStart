...
// УДАЛЕН обработчик с alert для кнопок "Купить сейчас"
// Вместо него добавлены обработчики для каждой кнопки
document.querySelectorAll('a[href="payment.html?plan=basic"], a[href="https://ioiow.github.io/FreelancePay/?plan=basic"]').forEach(btn => {
    btn.addEventListener('click', function(e) {
        e.preventDefault();
        window.location.href = 'payment.html?plan=basic';
    });
});

document.querySelectorAll('a[href="payment.html?plan=extended"], a[href="https://ioiow.github.io/FreelancePay/?plan=extended"]').forEach(btn => {
    btn.addEventListener('click', function(e) {
        e.preventDefault();
        window.location.href = 'payment.html?plan=extended';
    });
});
